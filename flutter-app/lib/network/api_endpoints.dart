...
class ApiEndpoints {
  ...
  static String channel(String code)       => '/channels/$code';
  /// Menu priced for one channel (overrides applied, hidden items removed).
  static String channelMenu(String code)   => '/channels/$code/menu';
  static String channelPrices(String code) => '/channels/$code/prices';
  ...
  static const String reportItemized       = '/reports/itemized';
  ...
  /// Unified multi-channel summary: every channel + overall totals.
  static const String reportByChannel      = '/reports/sales-by-channel';
  /// Items sold, bucketed per channel.
  static const String reportItemizedByChannel = '/reports/itemized-by-channel';
  /// Product × order-source pivot (weekly inventory): date_from, date_to,
  /// order_type, product_id, category_id.
  static const String reportProductSalesByChannel = '/reports/product-sales-by-channel';
  /// Standalone report for a single channel.
  static String reportChannel(String code) => '/reports/channel/$code';
